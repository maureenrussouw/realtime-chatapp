  ...
  return (
    <div className="p-4 border-t border-border flex items-center gap-2 bg-slate-950">
      ...
      {text.trim().length > 0 && (
        <button
          onClick={handleSend}
          className="w-10 h-10 bg-linear-to-r from-blue-500 to bg-purple-600 text-white hover:bg-blue-700 transition shrink-0 rounded-full cursor-pointer grid place-items-center"
        >
          <IoIosSend size={20} />
        </button>
      )}
